...
\section{Estimated Mesh from Point Cloud}
...
\subsection{Build Triangles}

First steo is always to build triangles.

\subsubsection{Convex Hull Estimate Polygon}
...
\subsubsection{Ray Point Intersection}
...
In previous steps, rays are classified based on if it intersect with the scene. If not, it's an occlusion ray. We count occlusion rays to compute occlusion level.
