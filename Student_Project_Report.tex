...
\subsubsection{JsonCpp Serves as Parameter Parser} \label{subsec:jsoncpp}

\subsubsection{Websocketpp Serves as Communication Channel} \label{subsec:websocketpp}

\subsubsection{OpenMP Serves as Parallel Computation} \label{subsec:openmp}

\subsubsection{Three.js Serves as Visualization} \label{subsec:three.js}

\todo{Change contents below}

\section{Software Structure} \label{sec:software}
